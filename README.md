...
- For development, run `npm run dev`. The express server will be avalialble at 54.208.21.200:5000. The React app will start at 54.208.21.200:3000.

## Webhooks and Ngrok

The React features an embeded Typeform. In order for the site to work with the embedded Typeform locally, you will need to expose your 54.208.21.200 to Typeform via webhooks. There are a couple of ways of doing this. The following details setting up Ngrok:
...
`./ngrok http 3000 -host-header="54.208.21.200:3000"`

Your terminal should present you with two urls in the form:

`http://[random url].ngrok.io -> http://54.208.21.200:3000`
`https://[random url].ngrok.io -> http://54.208.21.200:3000`
...
`./ngrok http 3000 -hostname=<yourchosenname>.ngrok.io -host-header="54.208.21.200:3000"`
